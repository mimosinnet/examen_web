use utf8;
package Examen_Web::Schema::Result::Resposte;
...
=head1 TABLE: C<respostes>

=cut

__PACKAGE__->table("respostes");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iDoZ8Lf2zvLa2fbZA2LE9w
